    ...
    \begin{enumerate}[label=(\alph*)]
        \item
            ...
            \begin{align*}
                ...
                & \text{iff}\quad I \models \exists x, y, z.\, \car(x) = y \land \cdr(x) = z \land x = \cons(y, z) \\
                & \text{iff}\quad J \models \car(x) = y \land \cdr(x) = z \land x = \cons(y, z) \\
                & \text{iff}\quad J \models \car(x) = y \text{ and } J \models \cdr(x) = z \text{ and } J \models x = \cons(y, z) \\
                & \text{iff}\quad \alpha_J[\car](\bullet) = \bullet \text{ and }
                                  \alpha_J[\cdr](\bullet) = \bullet \text{ and }
                                  \bullet = \alpha_J[\cons](\bullet, \bullet) \\
                & \text{iff}\quad \bullet = \alpha_J[\cons](\bullet, \bullet)
            \end{align*}
            where $J: I \vartriangleleft \{ x \mapsto \bullet, y \mapsto \bullet, z \mapsto \bullet \}$.
            If $\bullet = \alpha_J[\cons](\bullet, \bullet)$, then $(\textsf{construction})$ states $\atom(\bullet) \leftrightarrow \atom(\alpha_J[\cons](\bullet, \bullet))$ which is false by the axiom ($\atom$).
            \todo[inline,caption={}]{
                I don't like that I used proof by contradiction like this.
            }
    \end{enumerate}
\end{exer}
